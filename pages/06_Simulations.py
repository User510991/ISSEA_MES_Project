...
if selected_vars:
  ...
  df_filled[["inflat","chom","co2","ef_ser"]]=df_filled[["Inflat","Chomage","CO2","effet_serre"]]
  df_init1[["inflat","chom","co2","ef_ser"]]=df_init1[["Inflat","Chomage","CO2","effet_serre"]]

  col_names=[i for i in df_filled.columns if i not in ["FBCF","Imp_renouv","bal_ext_BS ","Inflat","Chomage","CO2","effet_serre"]]
